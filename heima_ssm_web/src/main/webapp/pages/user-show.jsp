                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="用户编号"
                               value="${userList.id }" readonly="readonly">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="密码"
                               value="${userList.password }" readonly="readonly">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="datepicker-a6" value="${userList.phoneNum}"
                                   readonly="readonly">
                        </div>
                    </div>


                    <div class="col-md-2 title rowHeight2x">当前权限</div>
                    <div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3" placeholder="权限信息">
                            ${userList.statusStr }
                        </textarea>
                    </div>
